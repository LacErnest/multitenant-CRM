...
@Component({
  selector: 'oz-finance-project-form-wrapper',
  templateUrl: './project-form-wrapper.component.html',
  styleUrls: ['./project-form-wrapper.component.scss'],
})
export class ProjectFormWrapperComponent implements OnInit, OnDestroy {
