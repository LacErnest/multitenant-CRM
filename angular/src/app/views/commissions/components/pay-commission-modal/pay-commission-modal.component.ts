...
@Component({
  selector: 'oz-finance-pay-commission-modal',
  templateUrl: './pay-commission-modal.component.html',
  styleUrls: ['./pay-commission-modal.component.scss'],
  animations: [
...
export class PayCommissionModalComponent implements OnInit {
