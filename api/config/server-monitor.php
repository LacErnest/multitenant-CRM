...
return [
    ...
    'notifications' => [
        ...
        'notifications' => [
            App\Notifications\MonitorCheckSucceeded::class => ['mattermost'],
            App\Notifications\MonitorCheckRestored::class => ['mattermost'],
            App\Notifications\MonitorCheckWarning::class => ['mattermost'],
            App\Notifications\MonitorCheckFailed::class => ['mattermost'],
...
//            Spatie\ServerMonitor\Notifications\Notifications\CheckFailed::class => ['slack'],
        ...
        'mattermost' => [
            'webhook_url' => 'https://mattermost.cyrextech.net/hooks/keppmqoxujd4xk7rammq3kajzc',
        ],
