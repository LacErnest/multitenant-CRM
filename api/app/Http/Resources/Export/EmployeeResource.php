...
class EmployeeResource extends ExtendedJsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $isCustomerFromUsa = $this->address->country && $this->address->country == Country::UnitedStatesOfAmerica()->getIndex();
        ...
        'VAR_BANK_ACCOUNT_NR'    => $isCustomerFromUsa ? $this->legalEntity->americanBank->usa_account_number ?? null : $this->legalEntity->americanBank->account_number ?? null,
        'VAR_BANK_ROUTING_NR'    => $isCustomerFromUsa ? $this->legalEntity->americanBank->usa_routing_number ?? null : $this->legalEntity->americanBank->routing_number ?? null,
        ];
    }
}
